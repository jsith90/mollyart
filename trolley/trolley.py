...
class Trolley():
	...
	def trolley_postage_packaging(self):
		...
		elif weight_total <= 10.8:
			postage = Decimal('14.00')
		elif weight_total <= 14:
			postage = Decimal('15.00')
		elif weight_total <= 20:
			postage = Decimal('21.00')
		elif weight_total <= 20.8:
			postage = Decimal('24.50')
		elif weight_total <= 24:
			postage = Decimal('25.50')
		elif weight_total <= 25:
			postage = Decimal('40.00')
		elif weight_total <=25.8:
			postage = Decimal('43.50')
		elif weight_total <= 29:
			postage = Decimal('44.50')
		elif weight_total <= 35:
			postage = Decimal('50.50')
		elif weight_total <= 35.8:
			postage = Decimal('54.00')
		elif weight_total <= 39:
			postage = Decimal('55.00')
		elif weight_total <= 45:
			postage = Decimal('61.00') 
		elif weight_total <= 50:
			postage = Decimal('40.00')
		elif weight_total <= 50.8:
			postage = Decimal('43.50')
		elif weight_total <= 54:
			postage = Decimal('44.50')
		elif weight_total <= 60:
			postage = Decimal('50.50')
		elif weight_total <= 60.8:
			postage = Decimal('54.00')
		elif weight_total <= 64:
			postage = Decimal('55.00')
		elif weight_total <= 70:
			postage = Decimal('61.00')
